      ...
      <div className="bg-black flex flex-col min-w-fit">
        ...
        <main className="min-h-[85vh]">
          ...
          <div className="p-1 text-center text-25px">
            ...
            <button className="m-5 px-7 py-3 border-double border-blue-400 border-2 bg-black rounded text-white  hover:border-green-500">
              <Link href="cooperateproposal">Cooperate Proposal</Link>
            </button>
          </div>
          <ListOfSubDAO />
        </main>
